...
poly-A length for each "PASS" mapped read. An additional column will be
printed at the beginning via the  ag=rgument '--opt-col-name', with values
from argument '--opt-col-val'.
"""
...
parser.add_argument("-c", "--polya-len-col-name", default="polyA",
...
parser.add_argument("-v", "--opt-col-val", default="Library-1",
...
# Add an extra column with user provided columna name and its row-values
